...
def get_data_from_json(path_to_json: str) -> list[dict]:
    """get data from the json file and return it as a list of dict"""
...
def get_data_from_csv(path_to_csv: str) -> list[dict]:
    """get data from the csv file and return it as a list of dict"""
    util_logger.info("START getting data from csv")

    try:
        df = pd.read_csv(path_to_csv, sep=";")
        util_logger.info("CSV file loaded")
        ...
        util_logger.error("CSV file is empty")
        return [{}]

    finally:
        util_logger.info("FINISH getting data from csv")
